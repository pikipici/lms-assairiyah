...
const AddCourse = dynamic(() => import("@/components/form/AddCourse"), {
  ssr: false,
...
const CustomCreateCourse: FC<CustomSheetProps> = ({ children }) => {
  return (
    <Sheet>
      ...
      >
        <div>
          <SheetHeader>
            ...
            <SheetDescription>
              Masukkan judul materi pembelajaran.
            </SheetDescription>
          </SheetHeader>
          <AddCourse />
          <SheetFooter>
            <SheetClose asChild>
              <Button form="add-course-form" type="submit" size="sm">
                Buat
              </Button>
            </SheetClose>
          </SheetFooter>
...
export default CustomCreateCourse;
