...
const AddMapel = dynamic(() => import("@/components/form/AddMapel"), {
  ssr: false,
...
const CustomSheetMapel: FC<CustomSheetProps> = ({ children }) => {
  return (
    <Sheet>
      ...
      >
        <div>
          <SheetHeader>
            <SheetTitle>Tambah mata pelajaran</SheetTitle>
            <SheetDescription>
              Tambah mata pelajaran pada kolom dibawah ini.
            </SheetDescription>
          </SheetHeader>
          <AddMapel />
          <SheetFooter>
...
export default CustomSheetMapel;
