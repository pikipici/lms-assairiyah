...
import { KelasForm } from "@/components/form/users/kelas-form";
...
const Page = async ({
  ...
  params: { adminId: string; userId: string };
}) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 mb-10">
                <div>
                  <div className="flex items-center gap-x-2">
                    ...
                    <h2 className="text-xl">Data Siswa</h2>
                  </div>
                  {/* image */}
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center gap-x-2">
                      ...
                      <h2 className="text-xl">Foto Siswa</h2>
                    </div>
