...
import { ForumClient } from "@/components/item/admin/forum/client";
import { ForumColumn } from "@/components/item/admin/forum/columns";
      ...
      <div>
        <div className="flex-col">
          <div className="flex-1 space-y-4 pl-2">
            <ForumClient data={formattedForum} adminId={adminId} />
          </div>
        </div>
      </div>
    </ShellMenu>
